...
if x > 0:
    ...
    if x == 0:           #x = 0      # atribuição
                         #x == 0     # comparação (retorna True)
        print("zero")
#O código acima é um exemplo de estrutura condicional em Python, onde a variável x é comparada com o valor 0 para determinar se é positiva ou negativa. 
